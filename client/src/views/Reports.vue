...
export default {
  ...
  setup() {
    ...
    // Max revenue used for bar chart height scaling — recomputed when data changes
    ...
    // Reload when any filter changes — reports respect warehouse/category/period filters
    ...
    // Format a number with commas and two decimal places using the browser locale API
    const formatNumber = (num) => {
      const n = Number(num) || 0
      return n.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
    }

    // Convert "YYYY-MM" to a short month + year string, respecting the active locale
    const formatMonth = (monthStr) => {
      ...
      // Use locale-aware short month abbreviations via the months translation keys
